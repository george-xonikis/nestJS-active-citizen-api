...
export const registrationEmailHtml = (email:string, activationCode: string): string => {
    return `<!DOCTYPE html>
            <html lang="en">
            <head>
                <meta charset="UTF-8"/>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <div>
                            <a href="${host}/auth/signup/activate/${email}/${activationCode}"
            ...
            <p id='link' style="color: #1f5cce; font-size: 14px;">
                ${host}/auth/signup/activate/${email}/${activationCode}
            </p>
